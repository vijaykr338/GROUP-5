...
public:
    void addPatient() {
        ...
        patients.push_back(Patient(name, age, disease, gender));
    ...
    void bookAppointment() {
        ...
        cout << "Select Patient by index:" << endl;
        for (int i = 0; i < patients.size(); ++i) {
            cout << i + 1 << ". " << patients[i].getName() << endl;
        }
        cin >> patientIndex;

        cout << "Select Doctor by index:" << endl;
        ...
        appointments.push_back(Appointment(patients[patientIndex - 1], doctors[doctorIndex - 1], date, time));
